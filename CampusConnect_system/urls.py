"""CampusConnect_system URL Configuration
...
from CampusConnect_app import views, HodViews, StaffViews, StudentViews
from CampusConnect_app.EditResultVIewClass import EditResultViewClass
from CampusConnect_system import settings
